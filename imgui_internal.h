...
namespace ImGui {
    ...
    IMGUI_API void RenderTextClipped(const ImVec2 &pos_min, const ImVec2 &pos_max, const char *text,
                                     ...
                                     ImGuiAlign align = ImGuiAlign_Default, const ImVec2 *clip_min = NULL,
    ...
    IMGUI_API void PushClipRect(const ImVec2 &clip_rect_min, const ImVec2 &clip_rect_max,
                                bool intersect_with_existing_clip_rect = true);
    ...
    IMGUI_API bool TreeNodeBehaviorIsOpened(ImGuiID id,
